...
if (isset($_GET['submit'])) {
    $persentase_diskon = $_GET['persentase_diskon'];
    $id_transaksi_final = $_GET['id_transaksi_final'];
    $q_insertdata = mysqli_query($koneksi, "INSERT INTO tb_diskon VALUES ('', '$persentase_diskon', '$id_transaksi_final')");
                ...
                <div class="card-body">
                    <form method="GET">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    <label for="input" class="mb-2">Diskon (%)</label>
                                    <input type="text" class="form-control" name="persentase_diskon" id="persentase_diskon" placeholder="Masukan Persentase Diskon (%)">
                                </div>
                            </div>
                        </div>
                        <div class="row gy-1">
                            <div class="col-md-6">
                                <input type="submit" name="submit" class="btn btn-success btn-sm btn-block" value="Input Diskon">
                            </div>
                            <div class="col-md-6">
