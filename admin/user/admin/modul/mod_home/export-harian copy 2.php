...
//CARI TOTAL CASH
$q_caricash = mysqli_query($koneksi, "SELECT SUM(distinct total_harga) AS total_cash FROM tb_transaksi left JOIN tb_cart ON (tb_cart.id_transaksi=tb_transaksi.id_transaksi) WHERE tgl_transaksi BETWEEN '$tgl_awal' AND '$tgl_akhir' AND metode_pembayaran='Cash'");
...
$q_caritf = mysqli_query($koneksi, "SELECT SUM(distinct total_harga) AS total_tf FROM tb_transaksi left JOIN tb_cart ON (tb_cart.id_transaksi=tb_transaksi.id_transaksi) WHERE tgl_transaksi BETWEEN '$tgl_awal' AND '$tgl_akhir' AND metode_pembayaran='Bank Transfer'");
...
//CARI TOTAL GoPay
$q_carigopay = mysqli_query($koneksi, "SELECT SUM(distinct total_harga) AS total_gopay FROM tb_transaksi left JOIN tb_cart ON (tb_cart.id_transaksi=tb_transaksi.id_transaksi) WHERE tgl_transaksi BETWEEN '$tgl_awal' AND '$tgl_akhir' AND metode_pembayaran='GoPay'");
...
//CARI TOTAL GoFood
$q_carigofood = mysqli_query($koneksi, "SELECT SUM(distinct total_harga) AS total_gofood FROM tb_transaksi left JOIN tb_cart ON (tb_cart.id_transaksi=tb_transaksi.id_transaksi) WHERE tgl_transaksi BETWEEN '$tgl_awal' AND '$tgl_akhir' AND metode_pembayaran='GoFood'");
...
$activeWorksheet->setTitle("EXPORT HARIAN");
