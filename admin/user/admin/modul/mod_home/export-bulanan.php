...
if ($bulanexport < 10 && $bulanexport > 0) {
    $bulanexportfix = "0" . $bulanexport;
} else {
    $bulanexportfix = $bulanexport;
}
...
$cariperiode = $tahunexport . "-" . $bulanexportfix;
...
$activeWorksheet->setTitle("BULANAN");
...
$dsl=array(
    new DataSeriesValues(DataSeriesValues::DATASERIES_TYPE_STRING, 'BULANAN!$I$5', NULL, 1, [], NULL, "6488ea"), //Cause of the error
);



$xal=array(
    new DataSeriesValues(DataSeriesValues::DATASERIES_TYPE_STRING, 'BULANAN!$H$6:$H$'.$first_grafik_row, NULL, $first_grafik_row),
);

$dsv = array(
    new DataSeriesValues(DataSeriesValues::DATASERIES_TYPE_NUMBER, 'BULANAN!$I$6:$I$'.$first_grafik_row, NULL, $first_grafik_row),
);
